...
# TA-COMMENT: you can also do (sorted(numbers))[-2]
...
for number in numbers:
    ...
    if number < 10:
        ...
        if number % 2 == 0:
            printnumber += 6
    if number > 50: # TA-COMMENT: This can be an elif; that way, python doesn't have to check both < 10 and > 50 (and we know those won't co-occur)
        printnumber -= 10
    if number != -10:
        printnumber -= 1
